    ...
    <div class="container">
        ...
        <nav id="breadcumds">
            <ul>
                ...
                <?php if ($parent) { ?>
                    <li><i class="fa fa-circle"></i><a href="/<?= $parent['link'] ?>"><?= $parent['name'] ?></a></li>
                <?php } ?>
                <li><i class="fa fa-circle"></i><a href="/<?= $category['link']; ?>"><?= $category['name']; ?></a></li>
                <!--<li><i class="fa fa-circle"></i><span><? /*= $model->post_title */ ?></span></li>-->
            </ul>
        </nav>
        <article id="div-article">
            <div class="blog-share-title">
                <div class="article_title"><h1 itemprop="headline"><?= $model->post_title ?></h1></div>
                <div class="article_time">
                    <i class="fa fa-clock-o" aria-hidden="true"></i>
                    <span class="time-post"><?= Yii::$app->formatter->asDate($model->created_at, 'yyyy-MM-dd'); ?></span>
                    <?php if ($author) { ?>
                        <i class="fa fa-user" aria-hidden="true"></i>
                        <span class="time-post">Biên tập viên: <a
                                    href="/author/<?= $author['link'] ?>"><?= $author['name'] ?></a></span>
                    <?php } ?>
                    <?php if ($doctor) { ?>
                        <i class="fa fa-user-md" aria-hidden="true"></i>
                        <span class="member">Tham vấn : <a
                                    href="/author/<?= $doctor['link'] ?>"><?= $doctor['name'] ?></a> </span>
                    <?php } ?>
                </div>
            </div>
            <!-- content -->
            <div class="content_article">
                ...
                <div class="button-share-mxh" style="width: 100%;float: left">
                    ...
                    <div class="share-fb" style="float: left;margin-left: 10px;">
                        <div class="fb-share-button" data-href="/<?= $model->post_name ?>" data-layout="button_count"
                ...
                <div>
                    ...
                    if (!Yii::$app->user->isGuest) {
                        $url = "/backend/news/update?id=" . $model->id;
                        echo Html::a('CHỈNH SỬA BÀI VIẾT', $url, ['class' => ['btn', 'btn-success']]);
                    }
                    ?>
                </div>
                ...
                <div class="comment">
                    ...
                    <div class="fb-comments"
                         data-href="<?= Yii::$app->params['url']['sitemaps'] . '/' . $model['post_name'] ?>"
