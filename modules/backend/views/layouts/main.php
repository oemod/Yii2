...
use app\widgets_admin\menu\MenuWidget;
...
<header>
    <div class="headerpanel">
        ...
        <div class="logopanel">
            <h2><a href="/backend">Nam Học SG</a></h2>
        </div><!-- logopanel -->
                    ...
                    <li>
                        <div class="btn-group">
                            <button type="button" class="btn btn-logged" data-toggle="dropdown">
                                <?php   echo Html::img(Yii::getAlias('@web') . '/upload/no-avatar.png', ['alt' => 'avatar', 'class' => 'img-circle']);
                                ?>
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="/backend/user/view"><i class="glyphicon glyphicon-cog"></i> Account Settings</a></li>
                                <li><a href="#"><i class="glyphicon glyphicon-question-sign"></i> Help</a></li>
                                <li><a href="/site/logout"><i class="glyphicon glyphicon-log-out"></i> Log Out</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
...
<?php
Modal::begin([
    // 'options' => ['onclick' => 'msn.deletePopup()'],
    //'headerOptions' => ['id' => 'modalHeader'],
    'id' => 'myModal',
    'class' => 'popup',
    // 'onclick'=>'msn.deletePopup()',
    //'size' => 'modal-lg',
